...
class LocalPlanner():
    ...
    def move_core(self, goal_pi= Pose2D()):
        ...
        while not self.finished:
            #---------------#
            #self.sub_odom.callback()# Done: deal with the callback fcn
            ...
            #self.twist.angular.z = self.odom.twist.twist.angular.z + angular_z_demand
            self.twist.angular.z = angular_z_demand
